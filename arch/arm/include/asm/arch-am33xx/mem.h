...
/* ST NOR chip on NOR cape for Beaglebone */
#define STNOR_GPMC_CONFIG1	0x00001200
#define STNOR_GPMC_CONFIG2	0x001C1C00
#define STNOR_GPMC_CONFIG3	0x00031701
#define STNOR_GPMC_CONFIG4	0x1C041C04
#define STNOR_GPMC_CONFIG5	0x000C1F1F
